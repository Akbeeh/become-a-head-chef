...
origins = [
    ...
    "http://localhost:4173",  # for the preview app
    "localhost:4173",  # for the preview app
    "http://localhost:3000",  # for the server app
    "http://192.168.1.83:3000",  # for the server app
]
